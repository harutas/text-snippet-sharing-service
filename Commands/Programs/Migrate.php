...
class Migrate extends AbstractCommand
{
  ...
  {
    return [
      (new Argument('rollback'))->setDescription('Roll backwards. An integer n may also be provided to rollback n times.')->setRequired(false)->setAllowAsShort(true),
      (new Argument('init'))->setDescription("Create the migrations table if it doesn't exist.")->setRequired(false)->setAllowAsShort(true),
    ];
  }
